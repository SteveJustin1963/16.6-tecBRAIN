...
Vision with 8x8 bit ADNS2620 vision chip found in the common optical use
A microphone 
ADC 
...
Make a animatronic head that has responsive head movement or tracking of light and sound 
